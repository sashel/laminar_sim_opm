...
for s = 1:length(SNRs)
    ...
    for methind = 1:length(methodnames)
        ...
        for i = 1:length(coreg_errs)
            ...
            data_file = fullfile(stem_dir,sprintf('/results_opm_sim_space_%d_axis_%d_ds_spmdev%s/',space,axis,coreg_errs{i}),...
        ...
        for i = 1:length(coreg_errs)
            ...
            data_dir = fullfile(stem_dir,sprintf('/results_opm_sim_space_%d_axis_%d_ds_spmdev%s/',space,axis,coreg_errs{i}),...
