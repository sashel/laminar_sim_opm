function plot_wholebrain_roi_sim_results_ds11(snr, varargin)
...
white_mesh = fullfile(params.surf_dir,'/sub-01/','surf','ds11_white.surf.gii');

orig_pial_mesh = fullfile(params.surf_dir,'/sub-01/','surf','pial.hc_PDw2.surf.gii');
pial_mesh = fullfile(params.surf_dir,'/sub-01/','surf','ds11_pial.surf.gii');
